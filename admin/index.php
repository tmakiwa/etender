...
try {
    ...
    $sql = "SELECT company_name, email FROM users WHERE email = :email";
...
<head>
  ...
  <title>e-tender | Adminstrator </title>
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tenders">
          ...
          <ul class="sidenav-second-level collapse" id="collapseProfile">
            <li>
              <a href="index.php?page=addtender.php">Add New Tender</a>
            </li>
			<li>
              <a href="index.php?page=tendermanagement.php">Tender Management</a>
            </li>

            <li>
              <a href="tendervaluation.php">Tender Valuation</a>
            </li>

            <li>
              <a href="tenderreports.php">Tender Reports</a>
            </li>
          </ul>
        </li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Suppliers">
          ...
          <ul class="sidenav-second-level collapse" id="collapseSuppliers">
            <li>
              <a href="index.php?page=suppliers.php">View Suppliers</a>
            </li>
			<li>
      ...
      <div class="row">
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card dashboard text-white bg-primary o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="index.php?page=tendermanagement.php">
          ...
          <div class="card dashboard text-white bg-warning o-hidden h-100">
            <div class="card-body">
              <div class="card-body-icon">
				...
				<div class="mr-5"><h5>Suppliers</h5></div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="index.php?page=suppliers.php">
              <span class="float-left">View Details</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card dashboard text-white bg-danger o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><h5>Users</h5></div>
            </div>
