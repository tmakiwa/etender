...
$sql = "SELECT c.id, t.tender_title, t.tender_price, t.tender_id FROM cart c
  ...
  <div class="content-wrapper">
    ...
    <table class="table table-bordered">
        ...
        <?php foreach ($cart_items as $item): ?>
            <tr>
                <td><?php echo htmlspecialchars($item['tender_title']); ?></td>
                <td><?php echo number_format($item['tender_price'], 2); ?></td>
                <td>
                    <a href="remove_from_cart.php?cart_id=<?php echo $item['id']; ?>">Remove</a>
                </td>
            </tr>
        <?php endforeach; ?>
    </table>
    <h3>Total: <?php echo number_format($total_price, 2); ?> ZAR</h3><br>
    <a href="checkout.php" class="btn_1 medium">Proceed to Checkout</a>
